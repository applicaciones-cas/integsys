 ...
 * @author Guanzon
 */
public class SelectIndustryCompany1 implements Initializable, ScreenInterface {
            ...
            cmbIndustry.setOnAction(event -> {
                ...
                if (selectedIndustry != null) {
                    ...
                    try {
                        ...
                        Logger.getLogger(SelectIndustryCompany1.class.getName()).log(Level.SEVERE, null, ex);
                    }
                }
            });
