 ...
 * @author User
 */
public class PurchaseOrderReturn_ConfirmationMonarchHospitalityController implements Initializable, ScreenInterface {
    ...
    private void cmdButton_Click(ActionEvent event) {
        ...
        try {
            ...
            Logger.getLogger(PurchaseOrderReturn_ConfirmationMonarchHospitalityController.class.getName()).log(Level.SEVERE, MiscUtil.getException(ex), ex);
        }
    }
