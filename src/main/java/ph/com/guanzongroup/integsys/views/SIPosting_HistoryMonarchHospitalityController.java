 ...
 * @author User
 */
public class SIPosting_HistoryMonarchHospitalityController implements Initializable, ScreenInterface {
    ...
    private void cmdButton_Click(ActionEvent event) {
        ...
        try {
            ...
            Logger.getLogger(SIPosting_HistoryMonarchHospitalityController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
