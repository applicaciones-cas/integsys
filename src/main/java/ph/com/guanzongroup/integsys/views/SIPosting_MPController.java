...
public class SIPosting_MPController implements Initializable, ScreenInterface {
    ...
    public void showAttachmentDialog() {
        ...
        try {
            stageAttachment.showDialog((Stage) btnSave.getScene().getWindow(), getClass().getResource("/com/rmj/guanzongroup/integsys/views/AttachmentDialog.fxml"), controller, "Attachment Dialog", false, false, true);
    ...
    public void showSerialDialog() {
        try {
            ...
            stageSerial.showDialog((Stage) btnSave.getScene().getWindow(), getClass().getResource("/com/rmj/guanzongroup/sidebarmenus/views/DeliveryAcceptance_SerialMP.fxml"), controller, "Inventory Serial", true, false, false);
