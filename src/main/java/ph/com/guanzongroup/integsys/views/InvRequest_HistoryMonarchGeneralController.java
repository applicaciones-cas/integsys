 ...
 * @author User
 */
public class InvRequest_HistoryMonarchGeneralController implements Initializable, ScreenInterface {

    @FXML
    private String psFormName = "Inv Stock Request History Monarch General";
