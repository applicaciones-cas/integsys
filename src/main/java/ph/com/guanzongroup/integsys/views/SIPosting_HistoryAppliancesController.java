 ...
 */
public class SIPosting_HistoryAppliancesController implements Initializable, ScreenInterface {
    ...
    @FXML
    private TableColumn tblRowNoDetail, tblOrderNoDetail, tblBrandDetail, tblDescriptionDetail, tblCostDetail, tblOrderQuantityDetail, tblReceiveQuantityDetail, tblTotalDetail, tblJERowNoDetail, tblReportMonthYearDetail, tblJEAcctCodeDetail, tblJEAcctDescriptionDetail, tblJECreditAmtDetail, tblJEDebitAmtDetail, tblRowNoAttachment, tblFileNameAttachment;
    @FXML
    ...
    private void cmdButton_Click(ActionEvent event) {
        ...
        if (source instanceof Button) {
            try {
                ...
                Logger.getLogger(SIPosting_HistoryAppliancesController.class.getName()).log(Level.SEVERE, null, ex);
            } catch (SQLException ex) {
                Logger.getLogger(SIPosting_HistoryAppliancesController.class.getName()).log(Level.SEVERE, null, ex);
            } catch (GuanzonException ex) {
                Logger.getLogger(SIPosting_HistoryAppliancesController.class.getName()).log(Level.SEVERE, null, ex);
...
//                Thread.sleep(1000);
    ...
    public void initTableOnClick() {
        ...
        JFXUtil.adjustColumnForScrollbar(tblViewTransDetailList, tblAttachments, tblViewJEDetails);
    }
    ...
    private void initButton(int fnValue) {
        ...
        //Ready
        JFXUtil.setButtonsVisibility(lbShow3, btnSerials, btnHistory);
        //Unkown || Ready
        JFXUtil.setButtonsVisibility(lbShow4, btnClose, btnBrowse);
        JFXUtil.setDisabled(true, apMaster, apDetail, apJEDetail, apJEMaster, apAttachments);
    }
