 ...
 * @author Team 2
 */
public class POQuotation_ApprovalController implements Initializable, ScreenInterface {
                ...
                switch (lsButton) {
                    ...
                    case "btnApprove":
                        ...
                        if (ShowMessageFX.YesNo(null, pxeModuleName, "Are you sure you want to approve transaction?") == true) {
                            poJSON = poController.POQuotation().ApproveTransaction("");
                            if ("error".equals((String) poJSON.get("result"))) {
                                ShowMessageFX.Warning(null, pxeModuleName, (String) poJSON.get("message"));
                                return;
                            } else {
                    ...
                    case "btnDisapprove":
                        ...
                        if (ShowMessageFX.YesNo(null, pxeModuleName, "Are you sure you want to disapprove transaction?") == true) {
                            poJSON = poController.POQuotation().DisApproveTransaction("");
                            if ("error".equals((String) poJSON.get("result"))) {
                                ShowMessageFX.Warning(null, pxeModuleName, (String) poJSON.get("message"));
                                return;
                            } else {
