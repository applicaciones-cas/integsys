 ...
 * @author User
 */
public class InvRequest_Roq_ConfirmationAppliancesGeneralController implements Initializable, ScreenInterface{
    @FXML
    private String psFormName = "Inv Stock Request ROQ Confirmation Appliances General";
   @FXML
    ...
    private void loadTableInvDetail() {
        ...
        if (invRequestController.StockRequest().Master().getTransactionStatus().equals(StockRequestStatus.OPEN)||
            ...
            CustomCommonUtil.setDisable(true,
                    ...
                    ,tfQOH,tfROQ,tfClassification,tfVariant,tfColor,tfBrand,tfModel,tfBarCode,dpTransactionDate,tfDescription,tfReferenceNo);
