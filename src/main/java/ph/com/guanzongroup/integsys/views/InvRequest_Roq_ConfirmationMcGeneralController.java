 ...
 * @author User
 */
public class InvRequest_Roq_ConfirmationMcGeneralController implements Initializable, ScreenInterface{
    @FXML
    private String psFormName = "Inv Stock Request ROQ Confirmation Mc General";
   @FXML
    ...
    private void loadTableInvDetail() {
        ...
        if (invRequestController.StockRequest().Master().getTransactionStatus().equals(StockRequestStatus.OPEN)||
            ...
            CustomCommonUtil.setDisable(true,
                    ...
                    ,dpTransactionDate,tfQOH,tfReferenceNo,tfROQ,tfClassification,tfVariant,tfColor,tfBrand,tfModel,tfBarCode,tfDescription);
