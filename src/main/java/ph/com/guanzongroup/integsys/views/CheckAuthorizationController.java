...
public class CheckAuthorizationController implements Initializable, ScreenInterface {
    ...
    @FXML
    private TableColumn tblRowNo, tblCheckBox, tblDVNo, tblDate, tblSupplier, tblPayeeName, tblBankName, tblBankAccount, tblTransAmount;
    @FXML
