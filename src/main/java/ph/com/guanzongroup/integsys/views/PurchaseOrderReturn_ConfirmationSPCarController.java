 ...
 * @author User
 */
public class PurchaseOrderReturn_ConfirmationSPCarController implements Initializable, ScreenInterface {
    ...
    int pnDetail = 0;
    int pnMain = 0;
    private final String pxeModuleName = "Purchase Order Return Confirmation SPCar";
    ...
    private void cmdButton_Click(ActionEvent event) {
        ...
        try {
                        ...
                        poJSON = poPurchaseReturnController.PurchaseOrderReturn().printRecord(() -> {
                            ...
                            Platform.runLater(() -> {
                                try {
                                    ...
                                    Logger.getLogger(PurchaseOrderReturn_ConfirmationSPCarController.class.getName()).log(Level.SEVERE, null, ex);
            ...
            Logger.getLogger(PurchaseOrderReturn_ConfirmationSPCarController.class.getName()).log(Level.SEVERE, MiscUtil.getException(ex), ex);
        }
    }
