 ...
 * @author User
 */
public class InvRequest_ConfirmationMonarchFoodController implements Initializable, ScreenInterface{
    
    @FXML
    private String psFormName = "Inv Stock Request Confirmation Monarch Food";
   @FXML
