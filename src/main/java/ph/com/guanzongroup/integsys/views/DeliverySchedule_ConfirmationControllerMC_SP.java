 ...
 * @author 12mnv
 */
public class DeliverySchedule_ConfirmationControllerMC_SP implements Initializable, ScreenInterface {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            ...
            Logger.getLogger(DeliverySchedule_ConfirmationControllerMC_SP.class.getName()).log(Level.SEVERE, null, ex);
            ...
            protected void succeeded() {
                ...
                tblColBranchName.setCellValueFactory(loModel -> {
                    try {
                        ...
                        Logger.getLogger(DeliverySchedule_ConfirmationControllerMC_SP.class
                                .getName()).log(Level.SEVERE, null, ex);
                        poLogWrapper.severe(psFormName + " :" + ex.getMessage());
                        return new SimpleStringProperty("");
                    }
