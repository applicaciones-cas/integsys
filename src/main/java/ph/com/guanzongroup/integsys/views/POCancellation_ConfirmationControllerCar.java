 ...
 * @author User
 */
public class POCancellation_ConfirmationControllerCar implements Initializable, ScreenInterface {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            ...
            Logger.getLogger(POCancellation_ConfirmationControllerCar.class.getName()).log(Level.SEVERE, null, e);
