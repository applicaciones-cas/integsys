 ...
 * @author User
 */
public class InvRequest_ConfirmationLPGeneralController implements Initializable, ScreenInterface{
    @FXML
    private String psFormName = "Inv Stock Request Confirmation LP General";
    @FXML
