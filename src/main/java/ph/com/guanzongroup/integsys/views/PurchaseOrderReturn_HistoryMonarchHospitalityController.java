 ...
 * @author User
 */
public class PurchaseOrderReturn_HistoryMonarchHospitalityController implements Initializable, ScreenInterface {
    ...
    private void cmdButton_Click(ActionEvent event) {
        ...
        try {
            ...
            Logger.getLogger(PurchaseOrderReturn_HistoryMonarchHospitalityController.class.getName()).log(Level.SEVERE, MiscUtil.getException(ex), ex);
        }
    }
    ...
    private void txtField_KeyPressed(KeyEvent event) {
        try {
            ...
            Logger.getLogger(PurchaseOrderReturn_HistoryMonarchHospitalityController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
