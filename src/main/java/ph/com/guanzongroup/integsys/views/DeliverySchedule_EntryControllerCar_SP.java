 ...
 * @author 12mnv
 */
public class DeliverySchedule_EntryControllerCar_SP implements Initializable, ScreenInterface {
    ...
    private String psFormName = "Delivery Schedule Entry Car SP";
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            ...
            Logger.getLogger(DeliverySchedule_EntryControllerCar_SP.class.getName()).log(Level.SEVERE, null, ex);
        ...
        if (laTransactionDetail == null) {
            ...
            tblColDetailName.setCellValueFactory(loModel -> {
                try {
                    ...
                    Logger.getLogger(DeliverySchedule_EntryControllerCar_SP.class
                            .getName()).log(Level.SEVERE, null, ex);
                    poLogWrapper.severe(psFormName + " :" + ex.getMessage());
    ...
    private void loadTransaction(String value, String fsColumn) throws SQLException, CloneNotSupportedException, GuanzonException {
        ...
        Task<ObservableList<Model_Delivery_Schedule_Master>> loadTransactionTask = new Task<ObservableList<Model_Delivery_Schedule_Master>>() {
            ...
            protected void failed() {
                ...
                Logger
                        .getLogger(DeliverySchedule_EntryControllerCar_SP.class
                                .getName()).log(Level.SEVERE, null, ex);
                poLogWrapper.severe(psFormName + " : " + ex.getMessage());
            }
