 ...
 * @author user
 */
public class PurchaseOrderReceivingReportsController implements Initializable, ScreenInterface {

    private static final org.slf4j.Logger log = LoggerFactory.getLogger(PurchaseOrderReceivingReportsController.class);
    private GRiderCAS poApp;
    private PurchaseOrderReceivingControllers poPurchasingController;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        poPurchasingController = new PurchaseOrderReceivingControllers(poApp, logWrapper);
        poJSON = poPurchasingController.PurchaseOrderReceiving().InitTransaction();
        poPurchasingController.PurchaseOrderReceiving().Master().setIndustryId(psIndustryID);
        poPurchasingController.PurchaseOrderReceiving().Master().setCompanyId(psCompanyID);
            ...
            (cmbId, selectedIndex, selectedValue) -> {
                switch (cmbId) {
                    ...
                    case "cmbStatus":
                        ...
                        poPurchasingController.PurchaseOrderReceiving().setTransactionStatus(String.valueOf(transStat));
                        loadTableMaster();
                        break;
                }
            }
    ...
    private void handleButtonAction(ActionEvent event) {
        ...
        switch (lsButton) {
            ...
            case "btnRetrieve":
                ...
                break;
            case "btnPrint":
                poJSON = poPurchasingController.PurchaseOrderReceiving().printReports(() -> {},isSummarized, data);
        ...
        if (presentation != null) {
            presentation.selectedToggleProperty().addListener((obs, oldVal, newVal) -> {
                ...
                if (selected == rbPresentation01) {
                    isSummarized = true;
                    poPurchasingController.PurchaseOrderReceiving().Master().setSummarized(true);

                } else if (selected == rbPresentation02) {
                    isSummarized = false;
                    poPurchasingController.PurchaseOrderReceiving().Master().setSummarized(false);
                }
    ...
    private void txtField_KeyPressed(KeyEvent event) {
        ...
        if (null != event.getCode()) {
            try {
                    ...
                    case F3:
                        switch (txtFieldID) {
                            ...
                            case "tfCategory":
                                ...
                                try {
                                    poJSON = poPurchasingController.PurchaseOrderReceiving().
                                                SearchCategory(lsValue, false);
                            ...
                            case "tfDestination":
                                ...
                                try {
                                    poJSON = poPurchasingController.PurchaseOrderReceiving()
                                            .SearchDestination(lsValue, false);
                ...
                Logger.getLogger(PurchaseOrderReceivingReportsController.class.getName()).log(Level.SEVERE, null, ex);
...
//        isSummarized = poPurchasingController.PurchaseOrderReceiving().Master().isSummarized();
    ...
    private void applyTableMode(boolean isSummarized) {
        ...
        if (isSummarized) {
            ...
            index03.setText("Supplier");
            index04.setText("Date Trans.");
            index05.setText("Refer. Date");
            index06.setText("Reference No.");
            index07.setText("Sales Invoice");
            index08.setText("Term");
            index09.setText("Vatable");
            index10.setText("Total");
            index11.setText("Amount Paid");
            index12.setText("Status");
            ...
            index06.setPrefWidth(120);
            index07.setPrefWidth(100);
            index08.setPrefWidth(120);
            index09.setPrefWidth(70);
            index10.setPrefWidth(150);
            index11.setPrefWidth(150);
            ...
            // DETAIL MODE
            index02.setText("Transaction No");
            index03.setText("Order No");
            index04.setText("Supplier");
            index05.setText("Date Trans.");
            index06.setText("Barcode");
            ...
            index12.setText(serial01);
            index13.setText(serial02);
            index14.setText("Conduction No");
            index15.setText("Qty");
            index16.setText("Unit Price Freight");
            index17.setText("Total");
            ...
            index17.setStyle("-fx-alignment: CENTER-RIGHT;"); // 💰 total

            index02.setPrefWidth(100);
            index03.setPrefWidth(100);
            index04.setPrefWidth(170);
            index05.setPrefWidth(80);
            index06.setPrefWidth(120);
            index07.setPrefWidth(130);
            index08.setPrefWidth(100);
            index09.setPrefWidth(120);
            index10.setPrefWidth(120);
            index11.setPrefWidth(80);
            index12.setPrefWidth(100);
            index13.setPrefWidth(100);
            index14.setPrefWidth(80);
            index15.setPrefWidth(50);
            index16.setPrefWidth(110);
            index17.setPrefWidth(110);
            // SHOW
                        ...
                        for (int i = 0; i < data.size(); i++) {
                            ...
                            if (isSummarized) {
                                ...
                                tempData.add(new ModelTableDetail(
                                        ...
                                        obj.get("sSupplierNme") == null ? "" : obj.get("sSupplierNme").toString(),
                                        obj.get("dTransact") == null ? "" : obj.get("dTransact").toString(),
                                        obj.get("dRefernce") == null ? "" : obj.get("dRefernce").toString(),
                                        obj.get("sReferNox") == null ? "" : obj.get("sReferNox").toString(),
                                        obj.get("sSalesInv") == null ? "" : obj.get("sSalesInv").toString(),
                                        obj.get("sTermNme") == null ? "" : obj.get("sTermNme").toString(),
                                        ...
                                        obj.get("nAmtPaidx") == null ? ""
                                                : CustomCommonUtil.setIntegerValueToDecimalFormat(
                                                Double.parseDouble(obj.get("nAmtPaidx").toString()), true),
                                ...
                                tempData.add(new ModelTableDetail(
                                        String.valueOf(i + 1),
                                        obj.get("sTransNox") == null ? "" : obj.get("sTransNox").toString(),
                                        obj.get("sOrderNox") == null ? "" : obj.get("sOrderNox").toString(),
                                        obj.get("sSupplierNme") == null ? "" : obj.get("sSupplierNme").toString(),
                                        obj.get("dTransact") == null ? "" : obj.get("dTransact").toString(),
                                        obj.get("sBarCodex") == null ? "" : obj.get("sBarCodex").toString(),
                                        obj.get("sBarcodeDesc") == null ? "" : obj.get("sBarcodeDesc").toString(),
                                        obj.get("sBrandNme") == null ? "" : obj.get("sBrandNme").toString(),
                                        obj.get("sModelCde") == null ? "" : obj.get("sModelCde").toString(),
                                        obj.get("sModelNme") == null ? "" : obj.get("sModelNme").toString(),
                                        obj.get("sColorNme") == null ? "" : obj.get("sColorNme").toString(),
                                        obj.get("sSerial01") == null ? "" : obj.get("sSerial01").toString(),
                                        obj.get("sSerial02") == null ? "" : obj.get("sSerial02").toString(),
                                        obj.get("sCStckrNo") == null ? "" : obj.get("sCStckrNo").toString(),
                                        obj.get("nQuantity") == null ? "" : obj.get("nQuantity").toString(),
                                        obj.get("nFreightx") == null ? ""
                                                : CustomCommonUtil.setIntegerValueToDecimalFormat(
                                                Double.parseDouble(obj.get("nFreightx").toString()), true),
                                        obj.get("nTotal") == null ? ""
                                                : CustomCommonUtil.setIntegerValueToDecimalFormat(
