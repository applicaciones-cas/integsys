 ...
 * @author User
 */
public class InvRequest_ConfirmationAppliancesGeneralController implements Initializable, ScreenInterface {

    @FXML
    private String psFormName = "Inv Stock Request Confirmation Appliances General";
     @FXML
