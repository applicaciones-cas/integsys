 ...
 * @author User
 */
public class InvRequest_ConfirmationAppliancesController implements Initializable, ScreenInterface {

    @FXML
    private String psFormName = "Inv Stock Request Confirmation Appliances";
