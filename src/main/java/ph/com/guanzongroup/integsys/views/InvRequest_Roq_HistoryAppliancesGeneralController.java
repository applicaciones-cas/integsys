 ...
 * @author User
 */
public class InvRequest_Roq_HistoryAppliancesGeneralController implements Initializable, ScreenInterface{
    @FXML
    private String psFormName = "Inv Stock Request ROQ History Appliances General";
