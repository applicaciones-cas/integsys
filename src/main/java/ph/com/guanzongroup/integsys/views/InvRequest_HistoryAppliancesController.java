 ...
 * @author User
 */
public class InvRequest_HistoryAppliancesController implements Initializable, ScreenInterface{
    @FXML
    private String psFormName = "Inv Stock Request History Appliances";
