 ...
 */
public class PurchaseOrderReturn_HistoryMCController implements Initializable, ScreenInterface {
    ...
    private void txtField_KeyPressed(KeyEvent event) {
        try {
            ...
            Logger.getLogger(PurchaseOrderReturn_HistoryMCController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
