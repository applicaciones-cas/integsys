 ...
 * @author User
 */
public class POCancellation_HistoryControllerMC implements Initializable, ScreenInterface {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            ...
            Logger.getLogger(POCancellation_HistoryControllerMC.class.getName()).log(Level.SEVERE, null, e);
