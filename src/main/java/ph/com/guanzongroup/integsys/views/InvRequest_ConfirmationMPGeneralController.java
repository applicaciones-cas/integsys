 ...
 * @author User
 */
public class InvRequest_ConfirmationMPGeneralController implements Initializable, ScreenInterface{
    @FXML
    private String psFormName = "Inv Stock Request Confirmation MP General";
  @FXML
