 ...
 * @author User
 */
public class PurchaseOrder_ApprovalSPCarController implements Initializable, ScreenInterface {

    private GRiderCAS poApp;
    private PurchaseOrderControllers poPurchasingController;
    private String psFormName = "Purchase Order Approval SPCar";
    ...
    public void initialize(URL url, ResourceBundle rb) {
        try {
            ...
            Logger.getLogger(PurchaseOrder_ApprovalSPCarController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
...
//                    }
    ...
    private void txtField_KeyPressed(KeyEvent event) {
        ...
        try {
            ...
            Logger.getLogger(PurchaseOrder_ApprovalSPCarController.class
