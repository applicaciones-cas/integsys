 ...
 * @author User
 */
public class CheckTransfer_EntryControllerOLD implements Initializable, ScreenInterface {
...
//        psCategoryID = fsValue;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            ...
            Logger.getLogger(CheckTransfer_EntryControllerOLD.class.getName()).log(Level.SEVERE, null, e);
            ...
            if (!nv) {
                ...
                switch (lsTextFieldID) {
                    ...
                    case "tfDestination":
                        ...
                        if (poAppController.getMaster().Branch()!= null) {
                            tfDestination.setText(
                                    poAppController.getMaster().Branch().getBranchName()
                            );
                        } else {
                            tfDestination.clear();
                        }
    ...
    private void loadTransactionMaster() {
        try {
            ...
            if (poAppController.getMaster().getDestination() != null
                    ...
                    tfDepartment.setDisable(!poAppController.getMaster().Branch().isMainOffice() 
                            && !poAppController.getMaster().Branch().isWarehouse());
            }
...
//        tfTotal.setText(CommonUtils.NumberFormat(poAppController.getMaster().getTransactionTotalDeposit(), "###,##0.0000"));
    ...
    private void clearAllInputs() {
        ...
        try {
            ...
            Logger.getLogger(CheckTransfer_EntryControllerOLD.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
