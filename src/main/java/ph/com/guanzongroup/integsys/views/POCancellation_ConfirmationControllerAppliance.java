 ...
 * @author User
 */
public class POCancellation_ConfirmationControllerAppliance implements Initializable, ScreenInterface {
    ...
    private TextField tfSearchTransaction, tfSearchSupplier, tfSearchReferNo,
            ...
            tfCancelAmount, tfBrand, tfModel, tfColor, tfCost, tfOrderQty,
            tfServedQty, tfCanceledQty, tfClass, tfAMC, tfROQ, tfVariant, tfInventoryType, tfQuantity;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            ...
            Logger.getLogger(POCancellation_ConfirmationControllerAppliance.class.getName()).log(Level.SEVERE, null, e);
