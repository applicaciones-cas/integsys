...
public class InvRequest_ConfirmationControllerMP implements Initializable, ScreenInterface {
    ...
    @FXML
    private String psFormName = "Inv Stock Request Confirmation MP";
                ...
                case "btnSave":
                    ...
                    if ("success".equals(poJSON.get("result")) && invRequestController.Master().getTransactionStatus().equals(StockRequestStatus.OPEN)
                        ...
                        try {
                            ...
                            Logger.getLogger(InvRequest_ConfirmationControllerMP.class.getName()).log(Level.SEVERE, null, ex);
                        }
                    }
