 ...
 * @author User
 */
public class InvRequest_HistoryLPGeneralController implements Initializable, ScreenInterface {

    @FXML
    private String psFormName = "Inv Stock Request History LP General";
