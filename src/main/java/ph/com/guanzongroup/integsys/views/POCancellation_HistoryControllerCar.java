 ...
 * @author User
 */
public class POCancellation_HistoryControllerCar implements Initializable, ScreenInterface {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            ...
            Logger.getLogger(POCancellation_HistoryControllerCar.class.getName()).log(Level.SEVERE, null, e);
