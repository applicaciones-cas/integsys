...
public class DeliverySchedule_HistoryControllerMC_SP implements Initializable, ScreenInterface {
    ...
    private String psFormName = "Delivery Schedule History MC SP";
...
//            poAppController.initFields();
            ...
            Logger.getLogger(DeliverySchedule_HistoryControllerMC_SP.class.getName()).log(Level.SEVERE, null, ex);
...
//                tblBranchList.getItems().clear();// Clear and update table
                ...
                tblColBranchName.setCellValueFactory(loModel -> {
                    try {
                        ...
                        Logger.getLogger(DeliverySchedule_HistoryControllerMC_SP.class
