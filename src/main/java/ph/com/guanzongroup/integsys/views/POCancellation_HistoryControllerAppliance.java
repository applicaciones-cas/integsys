 ...
 * @author User
 */
public class POCancellation_HistoryControllerAppliance implements Initializable, ScreenInterface {
    ...
    private TextField tfSearchTransaction, tfSearchSupplier, tfSearchReferNo,
            ...
            tfServedQty, tfCanceledQty, tfClass, tfAMC, tfROQ, tfVariant, tfInventoryType,
            tfQuantity;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            ...
            Logger.getLogger(POCancellation_HistoryControllerAppliance.class.getName()).log(Level.SEVERE, null, e);
