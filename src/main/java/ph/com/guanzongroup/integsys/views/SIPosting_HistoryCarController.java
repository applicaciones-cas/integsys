 ...
 */
public class SIPosting_HistoryCarController implements Initializable, ScreenInterface {
    ...
    public void showSerialDialog() {
        try {
            ...
            stageSerial.showDialog((Stage) btnBrowse.getScene().getWindow(), getClass().getResource("/com/rmj/guanzongroup/sidebarmenus/views/DeliveryAcceptance_SerialCar.fxml"), controller, "Inventory Serial", true, false, false);
    ...
    private void cmdButton_Click(ActionEvent event) {
        ...
        try {
            ...
            if (source instanceof Button) {
                ...
                if (JFXUtil.isObjectEqualTo(lsButton, "btnSave")) {
            ...
            Logger.getLogger(SIPosting_HistoryCarController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
