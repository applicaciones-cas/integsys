...
public class DeliverySchedule_HistoryControllerCar implements Initializable, ScreenInterface {
    ...
    private String psFormName = "Delivery Schedule History Car";
...
//            poAppController.initFields();
            ...
            Logger.getLogger(DeliverySchedule_HistoryControllerCar.class.getName()).log(Level.SEVERE, null, ex);
            ...
            protected void succeeded() {
                ...
                tblColBranchName.setCellValueFactory(loModel -> {
                    try {
                        ...
                        Logger.getLogger(DeliverySchedule_HistoryControllerCar.class
                                .getName()).log(Level.SEVERE, null, ex);
                        poLogWrapper.severe(psFormName + " :" + ex.getMessage());
                        return new SimpleStringProperty("");
                    }
