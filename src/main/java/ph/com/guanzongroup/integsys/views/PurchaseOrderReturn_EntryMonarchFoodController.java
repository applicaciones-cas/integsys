 ...
 * @author User
 */
public class PurchaseOrderReturn_EntryMonarchFoodController implements Initializable, ScreenInterface {
    ...
    private void cmdButton_Click(ActionEvent event) {
        ...
        try {
            ...
            Logger.getLogger(PurchaseOrderReturn_EntryMonarchFoodController.class.getName()).log(Level.SEVERE, MiscUtil.getException(ex), ex);
        } catch (ParseException ex) {
            Logger.getLogger(PurchaseOrderReturn_EntryMonarchFoodController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
            ...
            switch (event.getCode()) {
                ...
                case UP:
                    switch (lsID) {
                        case "tfBarcode":
                        case "tfReturnQuantity":
                            double lnQty = Double.valueOf(poPurchaseReturnController.PurchaseOrderReturn().Detail(pnDetail).getQuantity().toString());
                            apDetail.requestFocus();
                            double lnNewvalue = Double.valueOf(poPurchaseReturnController.PurchaseOrderReturn().Detail(pnDetail).getQuantity().toString());
