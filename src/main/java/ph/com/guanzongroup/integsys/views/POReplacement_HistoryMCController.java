 ...
 * @author Team 2
 */
public class POReplacement_HistoryMCController implements Initializable, ScreenInterface {
    ...
    @FXML
    private TextField tfSearchSupplier, tfSearchReferenceNo, tfTransactionNo, tfSupplier, tfTerm, tfTrucking, tfReferenceNo, tfDiscountAmount, tfTotal, tfDiscountRate, tfOrderNo, tfBrand, tfModel, tfModelVariant, tfColor, tfInventoryType, tfMeasure, tfCost, tfOrderQuantity, tfReceiveQuantity, tfAttachmentNo;
    @FXML
    private Label lblSource, lblStatus;
    @FXML
    private HBox hbButtons;
    @FXML
    private Button btnBrowse, btnSerials, btnPrint, btnHistory, btnClose, btnArrowLeft, btnArrowRight;
    @FXML
    ...
    @FXML
    private TableColumn tblRowNoDetail, tblOrderNoDetail, tblBrandDetail, tblDescriptionDetail, tblCostDetail, tblOrderQuantityDetail, tblReceiveQuantityDetail, tblTotalDetail, tblRowNoAttachment, tblFileNameAttachment;
    @FXML
    ...
    public void showSerialDialog() {
        ...
        try {
            ...
            try {
                ...
                stageSerialDialog.showDialog((Stage) apMainAnchor.getScene().getWindow(), getClass().getResource("/com/rmj/guanzongroup/sidebarmenus/views/DeliveryAcceptance_SerialMC.fxml"),
