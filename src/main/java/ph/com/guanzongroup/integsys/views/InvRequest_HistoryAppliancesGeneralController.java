 ...
 * @author User
 */
public class InvRequest_HistoryAppliancesGeneralController implements Initializable, ScreenInterface{
    @FXML
    private String psFormName = "Inv Stock Request History Appliances General";
