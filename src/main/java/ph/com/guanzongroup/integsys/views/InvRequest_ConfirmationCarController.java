 ...
 * @author User
 */
public class InvRequest_ConfirmationCarController implements Initializable, ScreenInterface {

    @FXML
    private String psFormName = "Inv Stock Request Confirmation Car";
