 ...
 * @author User
 */
public class POCancellation_ConfirmationControllerCar_SP implements Initializable, ScreenInterface {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            ...
            Logger.getLogger(POCancellation_ConfirmationControllerCar_SP.class.getName()).log(Level.SEVERE, null, e);
