 ...
 * @author 12mnv
 */
public class DeliverySchedule_EntryControllerMonarch_Food implements Initializable, ScreenInterface {
    ...
    private String psFormName = "Delivery Schedule Entry Monarch Food";
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            ...
            Logger.getLogger(DeliverySchedule_EntryControllerMonarch_Food.class.getName()).log(Level.SEVERE, null, ex);
...
//                    clearAllInputs();
    ...
    private void txtField_KeyPressed(KeyEvent event) {
        ...
        try {
            ...
            Logger.getLogger(DeliverySchedule_EntryControllerMonarch_Food.class
    ...
    private void loadTransaction(String value, String fsColumn) throws SQLException, CloneNotSupportedException, GuanzonException {
        ...
        Task<ObservableList<Model_Delivery_Schedule_Master>> loadTransactionTask = new Task<ObservableList<Model_Delivery_Schedule_Master>>() {
            ...
            protected void failed() {
                ...
                Logger
                        .getLogger(DeliverySchedule_EntryControllerMonarch_Food.class
                                .getName()).log(Level.SEVERE, null, ex);
                poLogWrapper.severe(psFormName + " : " + ex.getMessage());
            }
