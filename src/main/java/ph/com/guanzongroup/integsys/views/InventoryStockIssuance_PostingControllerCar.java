...
public class InventoryStockIssuance_PostingControllerCar implements Initializable, ScreenInterface {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            ...
            Logger.getLogger(InventoryStockIssuance_PostingControllerCar.class.getName()).log(Level.SEVERE, null, ex);
    ...
    final ChangeListener<? super Boolean> txtField_Focus = (o, ov, nv) -> {
        ...
        try {
            ...
            Logger.getLogger(InventoryStockIssuance_PostingControllerCar.class
    ...
    private void loadTransaction(String value, String fsColumn) throws SQLException, CloneNotSupportedException, GuanzonException {
        ...
        Task<ObservableList<Model_Inventory_Transfer_Master>> loadTransactionTask = new Task<ObservableList<Model_Inventory_Transfer_Master>>() {
            ...
            protected void failed() {
                ...
                Logger
                        .getLogger(InventoryStockIssuance_PostingControllerCar.class
                                .getName()).log(Level.SEVERE, null, ex);
                poLogWrapper.severe(psFormName + " : " + ex.getMessage());
            }
