 ...
 * @author User
 */
public class InvRequest_ConfirmationMcGeneralController implements Initializable, ScreenInterface{
    @FXML
    private String psFormName = "Inv Stock Request Confirmation Mc General";
    @FXML
