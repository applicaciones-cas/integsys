...
public class DeliverySchedule_HistoryControllerMC implements Initializable, ScreenInterface {
    ...
    private String psFormName = "Delivery Schedule History MC";
...
//            poAppController.initFields();
            ...
            Logger.getLogger(DeliverySchedule_HistoryControllerMC.class.getName()).log(Level.SEVERE, null, ex);
...
//                tblBranchList.getItems().clear();// Clear and update table
                ...
                tblColBranchName.setCellValueFactory(loModel -> {
                    try {
                        ...
                        Logger.getLogger(DeliverySchedule_HistoryControllerMC.class
                                .getName()).log(Level.SEVERE, null, ex);
                        poLogWrapper.severe(psFormName + " :" + ex.getMessage());
                        return new SimpleStringProperty("");
                    }
