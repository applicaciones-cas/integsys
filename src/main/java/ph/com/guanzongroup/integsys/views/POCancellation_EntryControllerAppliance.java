 ...
 * @author User
 */
public class POCancellation_EntryControllerAppliance implements Initializable, ScreenInterface {
    ...
    private TextField tfSearchTransaction, tfSearchSupplier, tfSearchReferNo,
            ...
            tfCancelAmount, tfBrand, tfModel, tfColor, tfOrderQty,
            tfServedQty, tfCanceledQty, tfClass, tfAMC, tfROQ, tfInventoryType, tfCost, tfVariant,
            tfQuantity;
    ...
    @FXML
    private TableColumn<Model_PO_Cancellation_Detail, String> tblColDetailNo, tblColDetailBrand, tblColDetailModel,
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            ...
            Logger.getLogger(POCancellation_EntryControllerAppliance.class.getName()).log(Level.SEVERE, null, e);
...
//                    loadRetrieveFilter();
    ...
    private void loadSelectedTransactionDetail(int fnRow) throws SQLException, GuanzonException, CloneNotSupportedException {
        ...
        tfModel.setText(tblColDetailModel.getCellData(tblIndex));
        ...
        tfVariant.setText(loDetailInventory.Variant().getDescription());
...
//        tfROQ.setText(String.valueOf(loDetailInventoryMaster.getReserveOrderQuantity()));
    ...
    private void initializeTableDetail() {
        if (paTransactionDetail == null) {
            ...
            tblColDetailModel.setCellValueFactory((loModel) -> {
                try {
