 ...
 * @author User
 */
public class InvRequest_Roq_ConfirmationMcController implements Initializable, ScreenInterface{
    @FXML
    private String psFormName = "Inv Stock Request ROQ Confirmation Mc";
    @FXML
