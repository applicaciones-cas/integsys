 ...
 * @author User
 */
public class PurchaseOrderReturn_HistoryMonarchFoodController implements Initializable, ScreenInterface {
    ...
    private void cmdButton_Click(ActionEvent event) {
        ...
        try {
            ...
            Logger.getLogger(PurchaseOrderReturn_HistoryMonarchFoodController.class.getName()).log(Level.SEVERE, MiscUtil.getException(ex), ex);
        }
    }
    ...
    private void txtField_KeyPressed(KeyEvent event) {
        try {
            ...
            Logger.getLogger(PurchaseOrderReturn_HistoryMonarchFoodController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
