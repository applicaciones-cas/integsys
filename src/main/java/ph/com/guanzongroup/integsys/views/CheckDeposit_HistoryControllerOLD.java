 ...
 * @author User
 */
public class CheckDeposit_HistoryControllerOLD implements Initializable, ScreenInterface {
...
//        psCategoryID = fsValue;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            ...
            Logger.getLogger(CheckDeposit_HistoryControllerOLD.class.getName()).log(Level.SEVERE, null, e);
