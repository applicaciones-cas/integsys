 ...
 * @author User
 */
public class POCancellation_EntryControllerCar implements Initializable, ScreenInterface {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            ...
            Logger.getLogger(POCancellation_EntryControllerCar.class.getName()).log(Level.SEVERE, null, e);
