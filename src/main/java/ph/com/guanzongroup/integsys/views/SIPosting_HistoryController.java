 ...
 * @author User
 */
public class SIPosting_HistoryController implements Initializable, ScreenInterface {
    ...
    @FXML
    private Button btnBrowse, btnSave, btnHistory, btnClose, btnArrowLeft, btnArrowRight, btnSerials;
    @FXML
    ...
    private TableColumn tblRowNoDetail, tblOrderNoDetail, tblBarcodeDetail, tblDescriptionDetail, tblCostDetail, tblOrderQuantityDetail, tblReceiveQuantityDetail,
            tblTotalDetail, tblJERowNoDetail, tblReportMonthDetail, tblJEAcctCodeDetail, tblJEAcctDescriptionDetail,
...
//            psIndustryId = "";
    ...
    public void showAttachmentDialog() {
        ...
        try {
            stageAttachment.showDialog((Stage) apMaster.getScene().getWindow(), getClass().getResource("/ph/com/guanzongroup/integsys/views/AttachmentDialog.fxml"), controller, "Attachment Dialog", false, false, true);
...
//            });
            ...
            stageSerial.showDialog((Stage) btnBrowse.getScene().getWindow(), getClass().getResource("/ph/com/guanzongroup/integsys/views/DeliveryAcceptance_Serial.fxml"), controller, "Inventory Serial", true, false, false);
...
//                Thread.sleep(1000);
    ...
    private void initButton(int fnValue) {
        ...
        JFXUtil.setButtonsVisibility(lbShow, btnSerials, btnHistory);
    ...
    public void clearTextFields() {
        Platform.runLater(() -> {
            ...
            JFXUtil.setValueToNull(previousSearchedTextField, lastFocusedTextField, dpTransactionDate, dpReferenceDate, dpSIDate, dpExpiryDate, dpReportMonthYear);
            psSupplierId = "";
            psBranchId = "";
