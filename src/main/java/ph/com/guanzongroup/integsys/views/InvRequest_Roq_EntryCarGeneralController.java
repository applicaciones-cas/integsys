 ...
 * @author User
 */
public class InvRequest_Roq_EntryCarGeneralController implements Initializable, ScreenInterface{
    @FXML
    private String psFormName = "Inv Stock Request ROQ Entry Car General";
    @FXML
