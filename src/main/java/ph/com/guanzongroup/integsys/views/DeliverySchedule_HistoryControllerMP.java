...
public class DeliverySchedule_HistoryControllerMP implements Initializable, ScreenInterface {
    ...
    private String psFormName = "Delivery Schedule History MP";
...
//            poAppController.initFields();
            ...
            Logger.getLogger(DeliverySchedule_HistoryControllerMP.class.getName()).log(Level.SEVERE, null, ex);
            ...
            protected void succeeded() {
                ...
                tblColBranchName.setCellValueFactory(loModel -> {
                    try {
                        ...
                        Logger.getLogger(DeliverySchedule_HistoryControllerMP.class
                                .getName()).log(Level.SEVERE, null, ex);
                        poLogWrapper.severe(psFormName + " :" + ex.getMessage());
                        return new SimpleStringProperty("");
                    }
