 ...
 * @author Guillier
 */
public class CheckRelease_EntryControllerOLD implements Initializable, ScreenInterface {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        try {
            ...
            Logger.getLogger(CheckRelease_EntryControllerOLD.class.getName()).log(Level.SEVERE, null, e);
    ...
    private void InitTransactionMaster() {
        ...
        try {
            ...
            Logger.getLogger(CheckRelease_EntryControllerOLD.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void InitCheckDetail() {
        ...
        try {
            ...
            if (pnTransactionDetail == poAppController.getDetailCount()) {
                pnTransactionDetail = pnTransactionDetail - 1;
            }
    ...
    private void LoadCheckPayments() {
        ...
        Task<ObservableList<Model_Check_Payments>> loadCheckPayment = new Task<ObservableList<Model_Check_Payments>>() {
            ...
            protected void failed() {
                ...
                Logger
                        .getLogger(CheckRelease_EntryControllerOLD.class
                                .getName()).log(Level.SEVERE, null, ex);
                poLogWrapper.severe(psFormName + " : " + ex.getMessage());
            }
