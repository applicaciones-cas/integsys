 ...
 * @author User
 */
public class InvRequest_Roq_ConfirmationMonarchGeneralController implements Initializable, ScreenInterface{
    @FXML
    private String psFormName = "Inv Stock Request ROQ Confirmation Monarch General";
  @FXML
