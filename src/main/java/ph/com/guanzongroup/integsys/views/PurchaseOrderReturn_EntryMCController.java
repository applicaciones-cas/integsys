 ...
 */
public class PurchaseOrderReturn_EntryMCController implements Initializable, ScreenInterface {

    private GRiderCAS oApp;
    private JSONObject poJSON;
    int pnDetail = 0;
    boolean lsIsSaved = false;
    private final String pxeModuleName = "Purchase Order Return Entry MC";
    ...
    private void datepicker_Action(ActionEvent event) {
        ...
        try {
            ...
            Logger.getLogger(PurchaseOrderReturn_EntryMCController.class.getName()).log(Level.SEVERE, null, ex);
...
dpTransactionDate);
    ...
    public void loadRecordSearch() {
        try {
            ...
            Logger.getLogger(PurchaseOrderReturn_EntryMCController.class.getName()).log(Level.SEVERE, MiscUtil.getException(ex), ex);
        }
    }
                    ...
                    try {
                        ...
                        for (lnCtr = 0; lnCtr < poPurchaseReturnController.PurchaseOrderReturn().getDetailCount(); lnCtr++) {
                            ...
                            if (poPurchaseReturnController.PurchaseOrderReturn().Detail(lnCtr).InventorySerialRegistration().getPlateNoP() != null
                                ...
                                lsPlateNo = poPurchaseReturnController.PurchaseOrderReturn().Detail(lnCtr).InventorySerialRegistration().getPlateNoP();
                            }
                            details_data.add(
