...
public class InventoryLocationController implements Initializable, ScreenInterface {
    ...
    private void initializeObject() {
        try {
            ...
            Logger.getLogger(InventoryLocationController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
                ...
                case F3:
                    switch (lnIndex) {
                        case 03:
                            ...
                            txtField03.setText((String) oParameters.Warehouse().getModel().getDescription());
                            break;
                        case 04:
                            ...
                            txtField04.setText((String) oParameters.Section().getModel().getDescription());
                            break;
                    }
                case ENTER:
            }
...
//                        oParameters.InventoryLocation().getModel().setWarehouseName(lsValue);
    ...
    private void loadRecord() {
        try {
            ...
            txtField03.setText(oParameters.InventoryLocation().getModel().Warehouse().getDescription());
            txtField04.setText(oParameters.InventoryLocation().getModel().Section().getDescription());
