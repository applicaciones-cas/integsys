 ...
 * @author User
 */
public class InvRequest_Roq_HistoryMcGeneralController implements Initializable, ScreenInterface {

    @FXML
    private String psFormName = "Inv Stock Request ROQ History Mc General";
