 ...
 * @author Team 1
 */
public class CheckDepositSupplier_PostingController implements Initializable, ScreenInterface {
    ...
    @FXML
    private AnchorPane AnchorMain, apBrowse, apButton, apMaster, apDetail, apAttachments, apTransaction;
    @FXML
