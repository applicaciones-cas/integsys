 ...
 */
public class CashFundLedgerController implements Initializable {
    ...
    public void setObject(CashFund foObject) {
                            ...
                            try {
                                ...
                                details_data.add(
                                        new ModelCashFundLedger(String.valueOf(lnRowCount),
                                                ...
                                                String.valueOf(poController.LedgerList(lnCtr).CashFund().getDescription()),
