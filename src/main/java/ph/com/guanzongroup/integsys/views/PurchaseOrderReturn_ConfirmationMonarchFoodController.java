 ...
 * @author User
 */
public class PurchaseOrderReturn_ConfirmationMonarchFoodController implements Initializable, ScreenInterface {
    ...
    int pnDetail = 0;
    int pnMain = 0;
    private final String pxeModuleName = "Purchase Order Return Confirmation MF";
                        ...
                        poJSON = poPurchaseReturnController.PurchaseOrderReturn().printRecord(() -> {
                            ...
                            Platform.runLater(() -> {
                                try {
                                    ...
                                    Logger.getLogger(PurchaseOrderReturn_ConfirmationMonarchFoodController.class.getName()).log(Level.SEVERE, null, ex);
