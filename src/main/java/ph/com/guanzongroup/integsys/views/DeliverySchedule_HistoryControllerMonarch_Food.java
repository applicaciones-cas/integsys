...
public class DeliverySchedule_HistoryControllerMonarch_Food implements Initializable, ScreenInterface {
    ...
    private String psFormName = "Delivery Schedule History Monarch Food";
...
//            poAppController.initFields();
            ...
            Logger.getLogger(DeliverySchedule_HistoryControllerMonarch_Food.class.getName()).log(Level.SEVERE, null, ex);
            ...
            protected void succeeded() {
                ...
                tblColBranchName.setCellValueFactory(loModel -> {
                    try {
                        ...
                        Logger.getLogger(DeliverySchedule_HistoryControllerMonarch_Food.class
                                .getName()).log(Level.SEVERE, null, ex);
                        poLogWrapper.severe(psFormName + " :" + ex.getMessage());
                        return new SimpleStringProperty("");
                    }
