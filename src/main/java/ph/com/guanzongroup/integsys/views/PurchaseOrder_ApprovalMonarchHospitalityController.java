 ...
 * @author User
 */
public class PurchaseOrder_ApprovalMonarchHospitalityController implements Initializable, ScreenInterface {

    private GRiderCAS poApp;
    private PurchaseOrderControllers poPurchasingController;
    private String psFormName = "Purchase Order Approval MH";
...
//                    }
    ...
    private void txtField_KeyPressed(KeyEvent event) {
        ...
        try {
            ...
            Logger.getLogger(PurchaseOrder_ApprovalMonarchHospitalityController.class
