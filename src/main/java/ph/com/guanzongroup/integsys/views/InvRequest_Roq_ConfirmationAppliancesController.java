 ...
 * @author User
 */
public class InvRequest_Roq_ConfirmationAppliancesController implements Initializable, ScreenInterface{
    @FXML
    private String psFormName = "Inv Stock Request ROQ Confirmation Appliances";
