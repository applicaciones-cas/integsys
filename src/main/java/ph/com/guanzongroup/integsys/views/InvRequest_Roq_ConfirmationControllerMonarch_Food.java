...
public class InvRequest_Roq_ConfirmationControllerMonarch_Food implements Initializable, ScreenInterface{
    ...
    @FXML
    private String psFormName = "Inv Stock Request ROQ Confirmation Monarch Food";
    @FXML
        ...
        private TextField tfTransactionNo,tfBrand,tfInvType
                ,tfROQ,tfClassification,tfQOH,tfReferenceNo,tfReservationQTY,
...
case "btnSave":
                        ...
                        try {
                            ...
                            Logger.getLogger(InvRequest_Roq_ConfirmationControllerMonarch_Food.class.getName()).log(Level.SEVERE, null, ex);
                        }
                            }
