 ...
 * @author User
 */
public class CheckTransfer_HistoryControllerOLD implements Initializable, ScreenInterface {
...
//        psCategoryID = fsValue;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            ...
            Logger.getLogger(CheckTransfer_HistoryControllerOLD.class.getName()).log(Level.SEVERE, null, e);
