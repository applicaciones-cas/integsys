 ...
 * @author User
 */
public class CheckTransfer_PostingControllerOLD implements Initializable, ScreenInterface {
...
//        psCategoryID = fsValue;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            ...
            Logger.getLogger(CheckTransfer_PostingControllerOLD.class.getName()).log(Level.SEVERE, null, e);
