...
import static ph.com.guanzongroup.integsys.views.DeliveryAcceptance_ConfirmationSPMCController.poPurchaseReceivingController;
 ...
 * @author User
 */
public class DeliveryAcceptance_HistoryCarController implements Initializable, ScreenInterface {
    ...
    int pnDetail = 0;
    int pnMain = 0;
    private final String pxeModuleName = "Purchase Order Receiving History Car";
    ...
    @FXML
    private Button btnPrint, btnHistory, btnSerials, btnClose; //btnUpdate, btnSearch, btnSave, btnCancel,  btnApprove, btnVoid, btnReturn
    @FXML
