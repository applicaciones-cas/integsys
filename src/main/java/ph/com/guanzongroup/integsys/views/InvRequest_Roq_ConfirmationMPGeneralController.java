 ...
 * @author User
 */
public class InvRequest_Roq_ConfirmationMPGeneralController implements Initializable, ScreenInterface{
    @FXML
    private String psFormName = "Inv Stock Request ROQ Confirmation MP General";
   @FXML
