 ...
 * @author User
 */
public class CheckRelease_HistoryControllerOLD implements Initializable, ScreenInterface{
    ...
    public void initialize(URL url, ResourceBundle rb) {
        try {
            ...
            Logger.getLogger(CheckRelease_HistoryControllerOLD.class.getName()).log(Level.SEVERE, null, e);
   ...
   @Override
    ...
    private void txtField_KeyPressed(KeyEvent event) {
        ...
        try{
            ...
            Logger.getLogger(CheckRelease_HistoryControllerOLD.class
    ...
    private void InitTransactionMaster(){
        ...
        try {
            ...
            Logger.getLogger(CheckRelease_HistoryControllerOLD.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
