 ...
 * @author User
 */
public class InvRequest_HistoryMPGeneralController implements Initializable, ScreenInterface {

    @FXML
    private String psFormName = "Inv Stock Request History MP General";
