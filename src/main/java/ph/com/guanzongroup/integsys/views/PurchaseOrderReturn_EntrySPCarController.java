 ...
 * @author User
 */
public class PurchaseOrderReturn_EntrySPCarController implements Initializable, ScreenInterface {
    ...
    private void cmdButton_Click(ActionEvent event) {
        ...
        try {
            ...
            Logger.getLogger(PurchaseOrderReturn_EntrySPCarController.class.getName()).log(Level.SEVERE, MiscUtil.getException(ex), ex);
        } catch (ParseException ex) {
            Logger.getLogger(PurchaseOrderReturn_EntrySPCarController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
