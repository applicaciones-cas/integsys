                    ...
                    try {
                        ...
                        Platform.runLater(() -> {
                            try {
                                ...
                                poJSON = poController.loadTransactionList(tfSearchIndustry.getText(), tfSearchSupplier.getText(), tfSearchTransaction.getText(), "", false, false);
                                int lnRowNo = 0;
...
//            }
            ...
            tfBankAccountCheck.setText(poController.Master().getDisbursementType().equals(DisbursementStatic.DisbursementType.CHECK)
