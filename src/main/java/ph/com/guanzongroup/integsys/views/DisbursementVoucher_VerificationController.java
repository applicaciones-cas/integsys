...
public class DisbursementVoucher_VerificationController implements Initializable, ScreenInterface {
    ...
    @FXML
    private Label lblSource, lblDVTransactionStatus, lblJournalTransactionStatus, tfAttachmentSource;
    @FXML
    ...
    private void cmdButton_Click(ActionEvent event) {
        try {
            ...
            if (JFXUtil.isObjectEqualTo(lsButton, "btnSave", "btnCancel", "btnVoid", "btnVerify", "btnDVCancel", "btnArrowRight", "btnArrowLeft", "btnHistory")) {
                pbIsCheckedJournalTab = false;
                pbIsCheckedBIRTab = false;
