 ...
 * @author Guillier
 */
public class CheckRelease_ConfirmationControllerOLD implements Initializable, ScreenInterface{
    ...
    public void initialize(URL url, ResourceBundle rb) {
        try {
            ...
            Logger.getLogger(CheckRelease_ConfirmationControllerOLD.class.getName()).log(Level.SEVERE, null, e);
   ...
   @Override
    ...
    void ontblMasterClicked(MouseEvent e) {
        ...
        try{
            ...
            Logger.getLogger(CheckRelease_ConfirmationControllerOLD.class
...
//                    }
    ...
    private void InitTransactionMaster(){
        ...
        try {
            ...
            Logger.getLogger(CheckRelease_ConfirmationControllerOLD.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
