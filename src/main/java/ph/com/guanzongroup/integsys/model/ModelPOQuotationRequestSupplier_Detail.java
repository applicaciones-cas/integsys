 ...
 * @author User
 */
public class ModelPOQuotationRequestSupplier_Detail {
    ...
    public ModelPOQuotationRequestSupplier_Detail(String index01,
            String index02,
            String index03,
            String index04,
            String index05,
    ...
    public ModelPOQuotationRequestSupplier_Detail(
            String index01,
            String index02,
            String index03,
            String index04,
